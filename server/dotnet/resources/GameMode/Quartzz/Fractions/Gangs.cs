...
namespace Quartzz.Fractions
{
    class Gangs : Script
    {
        ...
        {
            { 1, new Vector3(-138.57, -1593.37, 34.24) },
            { 2, new Vector3(105.42, -1941.81, 20.80) },
            { 3, new Vector3(482.50, -1889.30, 26.09) },
            { 4, new Vector3(1434.87, -1502.58, 62.86) },
            { 5, new Vector3(976.85, -1819.02, 31.15) },
        };
