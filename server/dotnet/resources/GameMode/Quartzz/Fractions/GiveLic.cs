...
namespace Quartzz.Fractions
{
    class GiveLic : Script
    {
        ...
        private static Vector3 Med = new Vector3(350.1617, -1409.2426, 31.4);
        ...
        private static int PriceMed = 3500; // цена на мед.карту
        private static int PriceGun = 20000; // цена на лицензию на оружие 
        ...
        public static void EnterShapeRealtor()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~w~Цена:3500$", Med + new Vector3(0, 0, 0.65), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                ...
                NAPI.TextLabel.CreateTextLabel("~w~Цена:20000$", Gun + new Vector3(0, 0, 0.65), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
