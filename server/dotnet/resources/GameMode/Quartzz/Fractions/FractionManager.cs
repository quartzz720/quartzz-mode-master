...
namespace Quartzz.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(526, Manager.FractionSpawns[16], 1.1f, 47, Main.StringToU16("Sheriff"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(671, Manager.FractionSpawns[1], 1.35f, 52, Main.StringToU16("The Families"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(671, Manager.FractionSpawns[2], 1.35f, 58, Main.StringToU16("The Ballas"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(671, Manager.FractionSpawns[3], 1.35f, 28, Main.StringToU16("Los Santos Vagos"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(671, Manager.FractionSpawns[4], 1.35f, 74, Main.StringToU16("Marabunta Grande"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(671, Manager.FractionSpawns[5], 1.35f, 49, Main.StringToU16("Blood Street"), 255, 0, true, 0, 0);

                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[10], 1, 5, Main.StringToU16("La Cosa Nostra"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, new Vector3(-1509.7269, 854.75305, 181.59457), 1, 5, Main.StringToU16("Итальянское посольство"), 255, 0, true, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[11], 1, 4, Main.StringToU16("Русская мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, new Vector3(-1538.8751, 118.46378, 56.78), 1, 4, Main.StringToU16("Русское посольство"), 255, 0, true, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[12], 1, 76, Main.StringToU16("Якудза"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, new Vector3(-1556.299, -90.074936, 54.33061), 1, 76, Main.StringToU16("Японское посольство"), 255, 0, true, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[13], 1, 40, Main.StringToU16("Армянская мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, new Vector3(-1811.5593, 438.29044, 128.70741), 1, 40, Main.StringToU16("Армянское посольство"), 255, 0, true, 0);

                /*NAPI.Blip.CreateBlip(668, new Vector3(-1123.202, 4929.628, 217.7096), 1, 75, Main.StringToU16("Redneck"), 255, 0, true, 0);*/
                NAPI.Blip.CreateBlip(280, new Vector3(-370.07, 31.250, 48.07), 1, 53, Main.StringToU16("Спавн новичков"), 255, 0, true, 0);
                NAPI.Blip.CreateBlip(637, new Vector3(-1586.07, 2791.09, 16.88), 1, 56, Main.StringToU16("Армия (КПП 1)"), 255, 0, true, 0);
                NAPI.Blip.CreateBlip(637, new Vector3(-2308.96, 3391.83, 30.97), 1, 56, Main.StringToU16("Армия (КПП 2)"), 255, 0, true, 0);
                NAPI.Blip.CreateBlip(431, new Vector3(648.986, 581.6053, 129.0475), 1, 53, Main.StringToU16("Б/У рынок"), 255, 0, true, 0);
        ...
        {
            {1, new Vector3(-143.17844, -1595.5087, 34.832626)},    // The Families
            {2, new Vector3(114.52688, -1957.4423, 20.818556)},     // The Ballas Gang
            {3, new Vector3(482.41672, -1893.4384, 26.094757)},     // Los Santos Vagos
            {4, new Vector3(1437.8947, -1496.465, 63.224495)},     // Marabunta Grande
            {5, new Vector3(971.7461, -1826.6384, 31.126368)},     // Blood Street
            {6, new Vector3(255, 228, 107)},      // Cityhall
            {7, new Vector3(457, -991, 31.5)},      // LSPD police
            {8, new Vector3(337.01392,-1403.2478,32.50954)},      // Emergency care
            {9, new Vector3(149, -756.5, 243)},     // FBI 
            {10, new Vector3(-1509.7269, 854.75305, 181.59457)},     // La Cosa Nostra 
            {11, new Vector3(-1538.8751, 118.46378, 56.78)},    // Russian Mafia
            {12, new Vector3(-1556.299, -90.074936, 54.33061)},    // Yakuza 
            {13, new Vector3(-1811.5593, 438.29044, 128.70741)},    // Armenian Mafia 
            ...
            {16, new Vector3(-442, 5987.6, 30.6)},    // Sheriff
        };
    ...
    class Stocks : Script
    {
        ...
        private static Dictionary<int, Vector3> garageCoords = new Dictionary<int, Vector3>()
        {
            ...
            //{ 16, new Vector3()},
            //{ 17, new Vector3()}, // TODO:
            { 16, new Vector3(-447.6798, 5993.688, 29.22054)}, // Sheriff 
        };
