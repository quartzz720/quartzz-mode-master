    ...
    class Ems : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                {
                    //Marker marker = NAPI.Marker.CreateMarker(1, emsCheckpoints[i] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(255, 255, 255, 0));
                }
            }
        ...
        {
            new Vector3(338.65, -1395.10, 32.50), // enter ems                0
            new Vector3(275.446, -1361.11, 23.5378),    // exit ems                 1
            new Vector3(354.2674, -1421.4178, 37.911175),  // spawn after death        2
            new Vector3(251.3914, -1346.518, 23.4178),  // open hospital stock      3
            new Vector3(246.223, -1353.053, 23.5378),   // duty change              4
            new Vector3(359.21106, -1391.6222, 32.42917),  // start heal course        5
            new Vector3(328.8122, -1432.5953, 29.817451), // tattoo delete            6
