...
namespace Quartzz
{
    ...
    { 
        public static string Codename { get; } = "Quartzz";
        ...
        public void Event_OnPlayerConnected(Player player)
        {
            try
            {
                ...
                player.SendChatMessage($"Вас приветствует Blunt Squad на Beta тесте.");
        ...
        public static void CMD_BUILD(Player client)
        {
            try
            {
                //client.SendChatMessage($"Сборка сервера (by Quartzz-Mode) !{{#00FFFF}}{Full}!{{#FFF}} успешно запущена !{{#f39c12}}{StartDate}");
            }
            catch { }
        }
